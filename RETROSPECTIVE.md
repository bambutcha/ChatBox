...
2. **Бекенд на Go**
   ...
   - Использование yagalog для логирования
...
4. **Дизайн**
   - Успешное воссоздание Telegram-like интерфейса
...
## Что сделал бы иначе, если бы было больше времени
...
- ✅ Рабочий функционал (отправка, сохранение, загрузка истории)
- ✅ Правильный дизайн, похожий на Telegram
